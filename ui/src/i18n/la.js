...
export default {
  ...
  "export.excelBadge": "ແນະນຳ: ສີແບ່ງໝວດ, ປັບຄວາມກວ້າງຖັນ & ຕິດຫົວຂໍ້",
  "export.csvBadge": "ຂໍ້ຄວາມດິບ UTF-8 BOM, ຂັ້ນດ້ວຍໝາຍຈຸດ",
  "export.viewTable": "ຮູບແບບຕາຕະລາງ",
  "export.viewRaw": "ຂໍ້ຄວາມດິບ",
  "export.colIdentity": "ຕົວຕົນ & ເວລາ",
  "export.colDevice": "ອຸປະກອນ & ລະບົບ",
  "export.colNetwork": "ເຄືອຂ່າຍ & ຜູ້ໃຫ້ບໍລິການ",
  "export.colLocation": "ສະຖານທີ່ & ທີ່ຢູ່",
  "export.colRadio": "ສັນຍານຄື້ນ",
  "export.colSpeed": "ຄວາມໄວ & ຄວາມໜ່ວງ",
  "export.colWebVideo": "ເວັບ & ວິດີໂອ",
  "export.colQoE": "ຄຸນນະພາບ QoE",
  ...
  "browse.browsedUrls": "ເວັບໄຊທີ່ເປີດ",
  "browse.time": "ເວລາ",
  "browse.rating": "ຄະແນນ",
  "browse.opening": "ກຳລັງເປີດ",
  "browse.noFrame": "ເວັບໄຊນີ້ບໍ່ອະນຸຍາດໃຫ້ສະແດງໃນກອບ",
  "browse.noFrameHint": "ກຳລັງວັດເວລາຕອບສະໜອງຂອງເຄືອຂ່າຍແທນ",
  "browse.responseNote": "* ເວລາຕອບສະໜອງ, ບໍ່ແມ່ນການໂຫຼດໜ້າເວັບທັງໝົດ",
  ...
  "video.tier": "ວິດີໂອ {quality}",
  "video.performanceRate": "ອັດຕາປະສິດທິພາບ",
  "video.initialLoading": "ເວລາໂຫຼດເບື້ອງຕົ້ນ",
  "video.bufferingTotal": "ເວລາລໍຖ້າລວມ",
  "video.dataUsed": "ຂໍ້ມູນທີ່ໃຊ້",
  "video.startingQuality": "ກຳລັງໂຫຼດວິດີໂອ {quality}...",
  "video.playingQuality": "ກຳລັງຫຼິ້ນວິດີໂອ {quality}...",
  "video.buffering": "ກຳລັງລໍຖ້າຂໍ້ມູນ...",
  "video.loadingResults": "ກຳລັງໂຫຼດຜົນ...",
  "video.finished": "ວັດການຫຼິ້ນວິດີໂອແລ້ວ",
  "video.decodedNote": "* ເຄື່ອງນີ້ນັບໄດ້ພຽງໄບຕເທີ່ຖອດລະຫັດແລ້ວ, ຕົ່ຳກວ່າຂໍ້ມູນທີ່ໂຫຼດມາແທ້",
  "video.estimateNote": "* ຂໍ້ມູນທີ່ໃຊ້ແມ່ນປະມານຈາກຂະໜາດໄຟລ໌, ບໍ່ໄດ້ນັບເປັນໄບຕ໌",
  "video.viewTiers": "ລາຍລະອຽດແຕ່ລະຄຸນນະພາບ ({count})",
  "video.tierLegend": "ອັດຕາປະສິດທິພາບ · ເວລາໂຫຼດເບື້ອງຕົ້ນ · ຂໍ້ມູນທີ່ໃຊ້",
  "video.probeNote": "* ເຄື່ອງນີ້ຫຼິ້ນວິດີໂອບໍ່ໄດ້, ຈຶ່ງວັດໄດ້ພຽງເວລາຕອບສະໜອງຂອງເຄືອຂ່າຍ",

  "unit.s": "s",

  "status.calculatingQoE": "ກຳລັງຄິດໄລ່ຄະແນນຄຸນນະພາບປະສົບການ (QoE)",
  "status.calculating": "ກຳລັງປະເມີນ",
  "status.calculatingDesc": "ກຳລັງລວມຄະແນນຄວາມໄວ, ຄວາມໜ່ວງ, ເວັບ ແລະ ວິດີໂອ ຕາມປະສົບການໃຊ້ງານຈິງ",
