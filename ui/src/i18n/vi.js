export default {
  ...
  "export.excelBadge": "Khuyên dùng: Màu sắc phân nhóm, tự căn độ rộng & ghim tiêu đề",
  "export.csvBadge": "Văn bản thuần UTF-8 BOM, phân tách bằng dấu phẩy",
  "export.viewTable": "Dạng bảng",
  "export.viewRaw": "Văn bản thô",
  "export.colIdentity": "Danh tính & Thời gian",
  "export.colDevice": "Thiết bị & Hệ thống",
  "export.colNetwork": "Mạng & Nhà mạng",
  "export.colLocation": "Vị trí & Tọa độ",
  "export.colRadio": "Sóng vô tuyến",
  "export.colSpeed": "Tốc độ & Độ trễ",
  "export.colWebVideo": "Web & Video",
  "export.colQoE": "Chất lượng QoE",
  ...
  "browse.noFrame": "Trang này không cho hiển thị trong khung",
  "browse.noFrameHint": "Đang đo thời gian phản hồi mạng thay thế",
  "browse.responseNote": "* thời gian phản hồi, không phải tải trọn trang",
  ...
  "video.performanceRate": "Hiệu suất phát",
  "video.initialLoading": "Thời gian tải ban đầu",
  "video.bufferingTotal": "Tổng thời gian chờ đệm",
  "video.dataUsed": "Dữ liệu đã dùng",
  "video.startingQuality": "Đang tải video {quality}...",
  "video.playingQuality": "Đang phát video {quality}...",
  ...
  "video.probeNote": "* máy này không phát được video, nên chỉ đo được thời gian phản hồi mạng",

  "unit.s": "s",

  "status.calculatingQoE": "Đang tính điểm chất lượng trải nghiệm (QoE)",
  "status.calculating": "Đang đánh giá",
  "status.calculatingDesc": "Tính toán đa chiều theo chuẩn trải nghiệm người dùng thực tế",
